...
INSERT INTO `producto`(`nombre_producto`, `precio`, `descripcion`,`id_categoria`, `existencias`,`foto1`,`foto2`,`foto3`) VALUES('Tiernosito café', '50', 'Tiernosito café esta listo para que acaricies, y cuides de él','1', '10', 'https://i.ibb.co/xHPXJw9/OsoCafe.jpg','https://i.ibb.co/vXBpXm0/OsoCafe1.jpg', 'https://i.ibb.co/wSd7D5w/OsoCafe2.jpg'); 
...
INSERT INTO `producto`(`nombre_producto`, `precio`, `descripcion`,`id_categoria`, `existencias`,`foto1`,`foto2`,`foto3`) VALUES ('Bebé de los cariñositos', '50', 'adaptable a mochila, sin daños','1','5','https://i.ibb.co/mS5fHF0/Oso-Rosita.jpg', 'https://i.ibb.co/nkmGVTb/Oso-Rosita1.jpg', 'https://i.ibb.co/DQsQpCh/Oso-Rosita2.jpg');    
...
INSERT INTO `producto`(`nombre_producto`, `precio`, `descripcion`, `id_categoria`, `existencias`,`foto1`,`foto2`,`foto3`) VALUES ('Alajero', '50','Alajero de ceramica con flores, bordes dorados en la base','3', '10', 'https://i.ibb.co/8KxkNZ6/Alajero.jpg', 'https://i.ibb.co/L8nh9mT/Alajero1.jpg', 'https://i.ibb.co/S3Ytyjf/Alajero2.jpg');  
...
--INSERT INTO `producto`(`nombre_producto`, `precio`, `descripcion`, `id_categoria`,  `existencias`,`foto1`,`foto2`,`foto3`) VALUES ('Plato largo', '50', 'Platón de ceramica, con la imagen de Cinnamoroll pintado a mano, con técnica de hoja de oro','3', '4');  
--INSERT INTO `producto`(`nombre_producto`, `precio`, `descripcion`, `id_categoria`, `existencias`,`foto1`,`foto2`,`foto3`) VALUES ('Alajero My Melody', '50', 'Pequeño alajero de My Melody, se asoma su figura','3', '10');  
--INSERT INTO `producto`( `nombre_producto`, `precio`, `descripcion`, `id_categoria`,  `existencias`, `foto1`,`foto2`,`foto3`) VALUES ('Pintura De Oso', '50', 'Pintura con técnica sobre oleo','4', '1');  
--INSERT INTO `producto`(`nombre_producto`, `precio`, `descripcion`, `id_categoria`, `existencias`,`foto1`,`foto2`,`foto3`) VALUES ('Pintura De Oso', '50', 'Pintura con técnica sobre oleo', '4', '1');


INSERT INTO `pedidos` ( `num_productos`,`direccion_envio`, `estado`,`usuario_id_usuario`) VALUES ('2', 'Calle del Conde de Peñalver 16 28006 Guadalajara', 'Activo', '1');
INSERT INTO `pedidos` ( `num_productos`,`direccion_envio`, `estado`,`usuario_id_usuario`) VALUES ('1', 'Avenida Piedras Negras 10 71980 Monterrey', 'Activo','2');
INSERT INTO `pedidos` ( `num_productos`,`direccion_envio`, `estado`,`usuario_id_usuario`) VALUES ('2', 'Avenida Siempre Viva 25 90900 CDMX', 'Activo','3');
INSERT INTO `pedidos` ( `num_productos`,`direccion_envio`, `estado`,`usuario_id_usuario`) VALUES ('4', 'Rincon Alegre 14  20165 Veracruz', 'Activo','4');
INSERT INTO `pedidos` ( `num_productos`,`direccion_envio`, `estado`,`usuario_id_usuario`) VALUES ('10', 'Esperanza Verde 15 78956 Xalapa', 'Activo','5');
INSERT INTO `pedidos` ( `num_productos`,`direccion_envio`, `estado`,`usuario_id_usuario`) VALUES ('2', 'Avenida Roma 257 10230 Nayarit', 'Activo','6');
